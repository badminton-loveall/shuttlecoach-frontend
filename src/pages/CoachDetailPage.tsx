...
export default function CoachDetailPage() {
  ...
  // Reset Password Modal state (HEAD_COACH/ADMIN only) — the modal itself
  // (form, submit, success state) lives in the shared ResetPasswordModal
  // component, reused by the student profile page too.
  ...
  return (
    <DashboardLayout>
      <div className="coach-detail-page bg-white min-h-screen">
        ...
        {/* Reset Password Modal (HEAD_COACH/ADMIN only) */}
        {isResetPasswordModalOpen && (
          <ResetPasswordModal
            targetName={coach.name}
            apiPath={`/coaches/${coachId}/reset-password`}
            sendEmailApiPath={`/coaches/${coachId}/send-reset-email`}
